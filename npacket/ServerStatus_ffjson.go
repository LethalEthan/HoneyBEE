...
// source: npacket/ServerStatus.go
...
handle_Version:
	...
	/* handler: j.Version type=npacket.StatusVersion kind=struct quoted=false*/
...
handle_Players:
	...
	/* handler: j.Players type=npacket.StatusPlayers kind=struct quoted=false*/
